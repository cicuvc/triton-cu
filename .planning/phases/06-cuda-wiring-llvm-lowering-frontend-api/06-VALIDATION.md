...
| 06-03-02 | 03 | 1 | SHLOWER-01 / SHLOWER-02 | T-06-06 / T-06-07 / T-06-08 | build + lit (regression) | `cd build && ninja triton-opt` exits 0; `lit -v test/TritonGPU/extern-call-mixed-inputs.mlir test/TritonGPU/extern-call-tensor-only.mlir` passes (regression — shared-args lit test deferred to 06-03-03 where the test file is created) | ❌ W0 | ⬜ pending |
